...
```
SyntaxError in line XX of $PATH/Snakemake_Tutorial/Snakefile:
...
```
SyntaxError in line 307 of /scicomp/home-pure/qpk9/GWAS_Study/Snakefile:
invalid syntax
```
...
There is a matching file in your input and output arguments so doublecheck the rule that snakemake complains about.  
